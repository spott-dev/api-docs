...
| ---------- | ------ | ------------- |
|`id`| String | Unique identificator given by Spott. |
|`geonameId`| Integer | Unique identificator given by [GeoNames](https://www.geonames.org). |
...
* `id`: Is the place identificator given by Spott.
